...
namespace DeliveryTracker.MOEA.Core
{
	...
	public class Solution
	{
		...
		public Solution(Problem problem)
		{
			...
			this.Variable = this.Type.CreateVariables();
		}
		...
		public int GetNumberOfBits()
		{
			...
			{
				if ((this.Variable[i].GetVariableType() == typeof(Binary) ||
					(this.Variable[i].GetVariableType() == typeof(BinaryReal))))

					bits += ((Binary)(this.Variable[i])).NumberOfBits;
			}
			return bits;
		}
	}
