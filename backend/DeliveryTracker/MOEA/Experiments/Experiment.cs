...
using System.IO;
using DeliveryTracker.MOEA.Experiments.Output;
...
namespace DeliveryTracker.MOEA.Experiments
{
	public class Experiment
	{
		...
		public Experiment(string name)
		{
			...
			this.IndicatorsMinimize = new Dictionary<string, bool>();

			this.IndicatorsMinimize.Add("HV", false);
			this.IndicatorsMinimize.Add("SPREAD", true);
			this.IndicatorsMinimize.Add("GD", true);
			this.IndicatorsMinimize.Add("IGD", true);
			this.IndicatorsMinimize.Add("EPSILON", true);
		}
		...
		public ExperimentResult RunExperiment()
		{
			...
			foreach (var experimentProblem in this.ExperimentProblems)
			{
