...
namespace DeliveryTracker.MOEA.Experiments.Output
{
	public class QualityIndicatorTables
	{
		...
		{
			var problems = this.experiment.ExperimentProblems;
			var referencePath = Path.Combine(this.experiment.ExperimentBaseDirectory, "ReferenceParetoFront");
