...
namespace DeliveryTracker.MOEA.Metaheuristics.PAES
{
	/// <summary>
	...
	public class PAES : Algorithm
	{
		...
		public override SolutionSet Execute()
		{
			...
			//Read the params
			Utils.Utils.GetIntValueFromParameter(this.InputParameters, "biSections", ref bisections);
			Utils.Utils.GetIntValueFromParameter(this.InputParameters, "archiveSize", ref archiveSize);
