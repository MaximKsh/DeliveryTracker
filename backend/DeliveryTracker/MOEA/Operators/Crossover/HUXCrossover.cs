...
namespace DeliveryTracker.MOEA.Operators.Crossover
{
	...
	public class HUXCrossover : Crossover
	{
		...
		public HUXCrossover(Dictionary<string, object> parameters)
			: base(parameters)
		{
			Utils.Utils.GetDoubleValueFromParameter(parameters, "probability", ref this.probability);
		}
		...
		public override object Execute(object obj)
		{
			...
			Solution[] offSpring = this.DoCrossover(this.probability, parents[0], parents[1]);
