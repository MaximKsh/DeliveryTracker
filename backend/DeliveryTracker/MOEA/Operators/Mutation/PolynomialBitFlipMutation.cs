...
namespace DeliveryTracker.MOEA.Operators.Mutation
{
	public class PolynomialBitFlipMutation : Mutation
	{
		...
		public PolynomialBitFlipMutation(Dictionary<string, object> parameters)
			: base(parameters)
		{
			Utils.Utils.GetDoubleValueFromParameter(parameters, "realMutationProbability", ref this.realMutationProbability);
			Utils.Utils.GetDoubleValueFromParameter(parameters, "binaryMutationProbability", ref this.binaryMutationProbability);
			Utils.Utils.GetDoubleValueFromParameter(parameters, "distributionIndex", ref this.distributionIndex);
		}
		...
		public override object Execute(object obj)
		{
			...
			if (!this.VALID_TYPES.Contains(solution.Type.GetType()))
			{
			...
			this.DoMutation(this.realMutationProbability.Value, this.binaryMutationProbability.Value, solution);
			return solution;
		}
