...
namespace DeliveryTracker.MOEA.Problems.Water
{
	public class Water : Problem
	{
		...
		public Water(string solutionType)
		{
			...
			this.NumberOfConstraints = 7;
			this.ProblemName = "Water";
			...
			{
				this.LowerLimit[var] = LOWERLIMIT[var];
				this.UpperLimit[var] = UPPERLIMIT[var];
			}
		...
		public override void Evaluate(Solution solution)
		{
			...
			double[] x = this.GetVariableValues(solution);
			// First function
