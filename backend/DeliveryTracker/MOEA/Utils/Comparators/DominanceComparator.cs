...
namespace DeliveryTracker.MOEA.Utils.Comparators
{
	public class DominanceComparator : IComparer<Solution>
	{
		...
		{
			this.violationConstraintComparator = new OverallConstraintViolationComparator();
		}
		...
		{
			this.violationConstraintComparator = comparator;
		}
		...
		public int Compare(Solution s1, Solution s2)
		{
			...
			if (this.violationConstraintComparator.NeedToCompare(s1, s2))
			{
				return this.violationConstraintComparator.Compare(s1, s2);
			}
