...
namespace DeliveryTracker.MOEA.Utils.Wrapper
{
	/// <summary>
	...
	public class XReal
	{
		...
		public double GetValue(int index)
		{
			...
			{
				result = ((Real)this.solution.Variable[index]).Value;
			}
			else if (type == typeof(BinaryRealSolutionType))
			{
				result = ((BinaryReal)this.solution.Variable[index]).Value;
			}
			else if (type == typeof(ArrayRealSolutionType))
			{
				result = ((ArrayReal)this.solution.Variable[0]).Array[index];
			}
		...
		public void SetValue(int index, double value)
		{
			...
			if (type == typeof(RealSolutionType))
			{
				((Real)this.solution.Variable[index]).Value = value;
			}
			else if (type == typeof(ArrayRealSolutionType))
			{
				((ArrayReal)this.solution.Variable[0]).Array[index] = value;
			}
			else if (type == typeof(ArrayRealAndBinarySolutionType))
			{
				((ArrayReal)this.solution.Variable[0]).Array[index] = value;
		...
		public double GetLowerBound(int index)
		{
			...
			if (type == typeof(RealSolutionType))
			{
				result = ((Real)this.solution.Variable[index]).LowerBound;
			}
			else if (type == typeof(BinaryRealSolutionType))
			{
				result = ((BinaryReal)this.solution.Variable[index]).LowerBound;
			}
			else if (type == typeof(ArrayRealSolutionType))
			{
				result = (double)((ArrayReal)this.solution.Variable[0]).GetLowerBound(index);
			}
			else if (type == typeof(ArrayRealAndBinarySolutionType))
				result = (double)((ArrayReal)this.solution.Variable[0]).GetLowerBound(index);
			else
		...
		public double GetUpperBound(int index)
		{
			...
			if (type == typeof(RealSolutionType))
			{
				result = ((Real)this.solution.Variable[index]).UpperBound;
			}
			else if (type == typeof(BinaryRealSolutionType))
			{
				result = ((BinaryReal)this.solution.Variable[index]).UpperBound;
			}
			else if (type == typeof(ArrayRealSolutionType))
			{
				result = (double)((ArrayReal)this.solution.Variable[0]).GetUpperBound(index);
			}
			else if (type == typeof(ArrayRealAndBinarySolutionType))
				result = (double)((ArrayReal)this.solution.Variable[0]).GetUpperBound(index);
			else
		...
		public int GetNumberOfDecisionVariables()
		{
			...
			{
				result = this.solution.Variable.Length;
			}
			else if (type == typeof(ArrayRealSolutionType))
			{
				result = ((ArrayReal)this.solution.Variable[0]).Size;
			}
			else
			{
