...
namespace DeliveryTracker.Tasks
{
    ...
    public class TaskStateCache
    {
        ...
        private const string NewUndistributedStateAlias = TaskStateAlias.NewUndistributedState;
        ...
        private const string NewStateAlias = TaskStateAlias.NewState;
        ...
        private const string InWorkStateAlias = TaskStateAlias.InWorkState;
        ...
        private const string PerformedStateAlias = TaskStateAlias.PerformedState;
        ...
        private const string CancelledStateAlias = TaskStateAlias.CancelledState;
        ...
        private const string CancelledByManagerStateAlias = TaskStateAlias.CancelledByManagerState;
